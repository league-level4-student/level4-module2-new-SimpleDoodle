...
public class DoWhileDemo {
	...
	public static void main(String[] args) {
		...
		/*
		 * It is also useful for avoiding code repetition whenever you must deal with
		 * input error as shown below. The code will repeat until exactly what was
		...
		/*
		 * 1. The code below would benefit from a do-while loop since the again String
		 * variable is dependent on user input. Convert it to a do-while loop so it will
